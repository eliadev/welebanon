								...
								<div role="tabpanel" class="tab-pane show active" id="descEnCat">
									<div class="form-group row">
										<div class="col-md-1"></div>
										 ...
										 <div class="col-sm-8">
											<textarea class="summernote-editor" id="DescEn" name="description_en">{!!$service->description_en!!}</textarea>
										 </div>
									</div>
								</div>
								<div role="tabpanel" class="tab-pane" id="descArCat">
									<div class="form-group row">
										<div class="col-md-1"></div>
										 ...
										 <div class="col-sm-8">
											<textarea class="summernote-editor" id="DescAr" name="description_ar">{!!$service->description_ar!!}</textarea>
										 </div>
									</div>
								</div>
							</div>
