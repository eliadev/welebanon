@extends('layouts.cmslayout')
	...
	@endif
    <form class="form-horizontal" action="{{route('plans.update', $plan->id)}}" method="POST" data-parsley-validate novalidate>
		@method('put')
		@csrf
		<div class="row">
			<div class="col-xl-8">
			   <div class="card-box">
							...
							<div class="tab-content">
								<div role="tabpanel" class="tab-pane fade show active" id="titleEnPlan">
									<div class="form-group row">
										...
										<div class="col-sm-8">
											<input type="text" name="name_en" value="{{$plan->name_en}}" class="form-control" id="titleEn" placeholder="Title English">
										</div>
									</div>
								</div>
								<div role="tabpanel" class="tab-pane fade" id="titleArPlan">
									<div class="form-group row">
										...
										<div class="col-sm-8">
											<input type="text" name="name_ar" value="{{$plan->name_ar}}" class="form-control" id="titleAr" placeholder="Title Arabic">
										</div>
									</div>
								</div>
							</div>
								...
								<div role="tabpanel" class="tab-pane show active" id="descEnPlan">
									<div class="form-group row">
										<div class="col-md-1"></div>
										 ...
										 <div class="col-sm-8">
											<textarea class="summernote-editor" id="DescEn" name="description_en">{!!$plan->description_en!!}</textarea>
										 </div>
									</div>
								</div>
								<div role="tabpanel" class="tab-pane" id="descArPlan">
									<div class="form-group row">
										<div class="col-md-1"></div>
										 ...
										 <div class="col-sm-8">
											<textarea class="summernote-editor" id="DescAr" name="description_ar">{!!$plan->description_ar!!}</textarea>
										 </div>
									</div>
								</div>
							</div>
				  ...
				  <div class="form-group row">
					...
					<div class="col-sm-8">
						<input type="text" name="points" value="{{$plan->points}}" class="form-control" id="points" placeholder="Points">
					</div>
				  </div>
				  <div class="form-group row">
					<div class="col-md-1"></div>
					...
					<div class="col-sm-8">
						<input type="number" name="price" value="{{$plan->price}}" class="form-control" id="price" placeholder="Price">
					</div>
				  </div>
			...
			<div class="col-xl-4">
			   <div class="card-box">
				...
				<a href="{{route('plans.create')}}" class="btn btn-secondary btn-rounded w-md waves-effect waves-light m-b-5" style="width:100%;">ADD NEW</a>
