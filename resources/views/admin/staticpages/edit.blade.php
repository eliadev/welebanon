@extends('layouts.cmslayout')
	...
	@endif
    <form class="form-horizontal" action="{{route('staticPages.update', $staticPage->id)}}" method="POST" enctype="multipart/form-data" data-parsley-validate novalidate>
		@method('put')
		@csrf
		<div class="row">
			<div class="col-xl-8">
			   <div class="card-box">
				  ...
				  <div class="row translate-bg">
							...
							<div class="tab-content">
								<div role="tabpanel" class="tab-pane fade show active" id="titleEnAbt">
									<div class="form-group row">
										...
										<div class="col-sm-8">
											<input type="text" name="name_en" value="{{ $staticPage->name_en }}" class="form-control" id="titleEn" placeholder="Title English">
										</div>
									</div>
								</div>
								<div role="tabpanel" class="tab-pane fade" id="titleArAbt">
									<div class="form-group row">
										...
										<div class="col-sm-8">
											<input type="text" name="name_ar" value="{{ $staticPage->name_ar }}" class="form-control" id="titleAr" placeholder="Title Arabic">
										</div>
									</div>
								</div>
							</div>
					...
					<div class="form-group row">
						...
						<div class="col-md-2">
							<img src="{{$staticPage->getFirstMediaUrl('staticPage', 'thumb')}}">
						</div>
						<div class="col-md-2">
								...
								<div role="tabpanel" class="tab-pane show active" id="descEnAbt">
									<div class="form-group row">
										<div class="col-md-1"></div>
										 ...
										 <div class="col-sm-8">
											<textarea class="summernote-editor" id="DescEn" name="description_en">{!! $staticPage->description_en !!}</textarea>
										 </div>
									</div>
								</div>
								<div role="tabpanel" class="tab-pane" id="descArAbt">
									<div class="form-group row">
										<div class="col-md-1"></div>
										 ...
										 <div class="col-sm-8">
											<textarea class="summernote-editor" id="DescAr" name="description_ar">{!! $staticPage->description_ar !!}</textarea>
										 </div>
									</div>
								</div>
							</div>
